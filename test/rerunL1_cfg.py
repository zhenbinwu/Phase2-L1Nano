...
from DPGAnalysis.Phase2L1TNanoAOD.l1tPh2Nano_cff import addFullPh2L1Nano
process = addFullPh2L1Nano(process)

process.load('PhysicsTools.L1Nano.l1tPh2MuNano_cff')
from PhysicsTools.L1Nano.l1tPh2MuNano_cff import addPh2L1MuonObjects
process = addPh2L1MuonObjects(process)
