...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1simulation_step,process.L1TrackTrigger_step, process.user_step,process.endjob_step,process.NANOAODoutput_step)
...
from PhysicsTools.L1Nano.l1tPh2Nano_cff import addPh2L1MuNano 

# from PhysicsTools.L1Nano.l1tPh2MuNanotables_cff import addPh2L1MuNano 
# #call to customisation function addPh2L1MuNano imported from PhysicsTools.L1Nano.l1tPh2Nano_cff
process = addPh2L1MuNano(process)
