...
Tau23MusTable = cms.EDProducer( "SimpleTriggerL1Tau23MuFlatTableProducer",
                                src = cms.InputTag('l1tTau23MusGmt'),
                                name = cms.string("tau23mu"),
                                doc = cms.string("Tau to 3 muons candidates"),
                                singleton = cms.bool(False), # the number of entries is variable
                                variables = cms.PSet(
                                  hwMass = Var("hwMass()", "int16", doc="mass"),
				  mu1 = Var("hwMu1()", "int16"),
				  mu2 = Var("hwMu2()", "int16"),
				  mu3 = Var("hwMu3()", "int16"),
                                  # pt = Var("emtfPt()", int), 
